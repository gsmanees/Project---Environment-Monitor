...
// for RS pin - CHANGED PORT AND PIN BECAUSE HERE SPI NEED THIS PIN 
#define LCD_RS_PORT   PORTD
#define LCD_RS_DDR    DDRD
#define LCD_RS_PIN    PD7

// for enable pin EN -  CHANGED PORT AND PIN BECAUSE HERE SPI NEED THIS PIN 
